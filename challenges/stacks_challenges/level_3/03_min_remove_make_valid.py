...
if __name__ == '__main__':
    TEST_CASES = [
        ...
        ('boundaries: parentheses-only edge patterns', test_02_boundaries_only_parentheses_and_off_by_one_patterns),
        ('interactions: validity/subsequence/minimality', test_03_interactions_output_is_valid_subsequence_and_minimal),
    ]
