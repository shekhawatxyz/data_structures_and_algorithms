...
def test_reorder_short_lists_stay_valid():
    ...
    _assert_equal(
        _linked_list_to_list(final_one),
        [7],
    ...
    _assert_equal(
        _linked_list_to_list(final_two),
        [7, 8],
        "Two-node list should remain unchanged.",
    )
...
def test_reorder_empty_list_is_handled():
    ...
    _assert_true(
        final_head is None, "reorder(None) should return None or keep None unchanged."
    )
