# Level 7.4 - remove_duplicates_unsorted_no_extra(head)
...
def test_remove_duplicates_no_extra_no_duplicates_case():
...
def test_remove_duplicates_no_extra_all_duplicates_case():
    head = _make_linked_list([8, 8, 8])
    result = remove_duplicates_unsorted_no_extra(head)
    _assert_equal(
        _linked_list_to_list(result),
        [8],
