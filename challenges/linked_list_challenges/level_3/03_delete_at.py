# Level 3.3 - delete_at(head, index)
...
def test_delete_at_middle_index():
    head = _make_linked_list([1, 2, 3, 4])
    result = delete_at(head, 2)
    _assert_equal(
        _linked_list_to_list(result),
        [1, 2, 4],
...
def test_delete_at_raises_for_invalid_indexes():
    head = _make_linked_list([1, 2, 3])
    _assert_raises(
