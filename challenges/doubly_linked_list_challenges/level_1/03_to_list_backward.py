...
def test_to_list_backward_none_returns_empty_list():
    _assert_equal(
        to_list_backward(None), [], "to_list_backward(None) should return []."
    )
...
def test_to_list_backward_single_node():
    ...
    _assert_equal(
        to_list_backward(head), [8], "Single-node backward traversal should return [8]."
    )
...
if __name__ == "__main__":
    TEST_CASES = [
        ...
        (
            "multi-node reverse order",
            test_to_list_backward_multiple_nodes_returns_reverse_order,
        ),
        (
            "matches forward reverse",
            test_to_list_backward_matches_forward_reverse_for_valid_list,
        ),
    ]
